...
func (p *argonPasswordProvider) Generate(password string) (string, error) {
...
func (p *argonPasswordProvider) Compare(password, encodedHash string) (bool, error) {
